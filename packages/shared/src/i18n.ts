...
const TRANSLATIONS: Translations = {
  ...
  "cal.no_teammates": { en: "You are the only member of this workspace.", pl: "Jesteś jedynym członkiem tego obszaru roboczego.", ru: "Вы единственный участник этого рабочего пространства.", uk: "Ви єдиний учасник цього робочого простору.", ar: "أنت العضو الوحيد في مساحة العمل هذه.", fr: "Vous êtes le seul membre de cet espace.", de: "Sie sind das einzige Mitglied dieses Workspace.", es: "Eres el único miembro de este espacio.", pt: "Você é o único membro deste espaço.", it: "Sei l'unico membro di questo spazio.", tr: "Bu çalışma alanının tek üyesisiniz.", nl: "Je bent het enige lid van deze workspace." },
  "cal.invite_teammates": { en: "Invite teammates", pl: "Zaproś współpracowników", ru: "Пригласить коллег", uk: "Запросити колег", ar: "دعوة زملاء الفريق", fr: "Inviter des collègues", de: "Teammitglieder einladen", es: "Invitar compañeros", pt: "Convidar colegas", it: "Invita colleghi", tr: "Takım arkadaşlarını davet et", nl: "Teamleden uitnodigen" },
  "cal.or_add_guest": { en: "or add anyone by email below", pl: "lub dodaj dowolną osobę e-mailem poniżej", ru: "или добавьте любого по электронной почте ниже", uk: "або додайте будь-кого електронною поштою нижче", ar: "أو أضف أي شخص عبر البريد الإلكتروني أدناه", fr: "ou ajoutez quelqu'un par e-mail ci-dessous", de: "oder unten jemanden per E-Mail hinzufügen", es: "o añade a alguien por correo abajo", pt: "ou adicione alguém por e-mail abaixo", it: "o aggiungi qualcuno via e-mail qui sotto", tr: "veya aşağıdan e-posta ile ekleyin", nl: "of voeg hieronder iemand toe via e-mail" },
  "cal.when": { en: "When", pl: "Kiedy", ru: "Когда", uk: "Коли", ar: "متى", fr: "Quand", de: "Wann", es: "Cuándo", pt: "Quando", it: "Quando", tr: "Ne zaman", nl: "Wanneer" },
  "cal.where": { en: "Where", pl: "Gdzie", ru: "Где", uk: "Де", ar: "أين", fr: "Où", de: "Wo", es: "Dónde", pt: "Onde", it: "Dove", tr: "Nerede", nl: "Waar" },
