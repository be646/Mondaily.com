...
function CreateDealModal({ defaultStage, onClose, onCreated }: {
  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/2 z-50 w-[440px] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-[var(--border-soft)] bg-[#13151a] shadow-[0_24px_64px_rgba(0,0,0,0.7)]">
