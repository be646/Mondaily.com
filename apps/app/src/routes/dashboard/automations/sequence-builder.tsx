        ...
        >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-md p-1 text-slate-700 hover:bg-red-500/10 hover:text-red-400 transition-colors"
            >
              <Trash2 size={12}/>
            </button>
            ...
            {step.position > 1 && (
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-16 rounded-md border border-white/[.07] bg-white/[.03] px-2 py-1 text-xs text-white outline-none focus:border-red-500/30"
                />
                <select
                  value={step.delay_unit}
                  onChange={e => onUpdate(step.id, { delay_unit: e.target.value as Step["delay_unit"] })}
                  className="rounded-md border border-white/[.07] bg-[#0d0f13] px-2 py-1 text-xs text-white outline-none focus:border-red-500/30"
                >
              ...
              <>
                <div className="grid grid-cols-[80px_1fr] items-center gap-2">
                  ...
                  <input
                    ...
                    className="rounded-md border border-white/[.07] bg-white/[.03] px-2.5 py-1.5 text-xs text-white placeholder-slate-700 outline-none focus:border-red-500/30"
                  />
                </div>
                {seq.accounts.length > 0 && (
                  <div className="grid grid-cols-[80px_1fr] items-center gap-2">
                    ...
                    <select
                      ...
                      className="rounded-md border border-white/[.07] bg-[#0d0f13] px-2.5 py-1.5 text-xs text-white outline-none focus:border-red-500/30"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-md border border-white/[.07] bg-white/[.03] px-2.5 py-2 text-xs text-white placeholder-slate-700 outline-none focus:border-red-500/30 resize-none"
                  />
                </div>
              </>
            ) : (
    ...
    <div className="flex min-h-full flex-col">
      ...
      <div className="flex items-center gap-3 border-b border-white/[.06] px-6 py-3">
        ...
        {nameEdit ? (
          ...
          <h1
            className="flex-1 cursor-pointer text-[15px] font-semibold text-white hover:text-red-400 transition-colors truncate"
        ...
        <button
          ...
          disabled={patchSeq.isPending}
          className={`flex items-center gap-1.5 rounded-lg border-x border-t border-b-[3px] px-3 py-1.5 text-xs font-semibold transition-all active:translate-y-[1px] disabled:opacity-50 ${seq.status === "active" ? "border-yellow-500/40 border-b-yellow-700 bg-yellow-500/80 text-white hover:bg-yellow-400" : "border-red-500/50 border-b-red-700 bg-red-500 text-white hover:bg-red-400"}`}
        >
      ...
      <div className="flex border-b border-white/[.06] px-6">
        {tabs.map(t => (
          <button
            ...
            className={`flex items-center gap-1.5 border-b-2 px-4 py-2.5 text-xs font-medium transition-colors ${tab === t.key ? "border-red-500 text-white" : "border-transparent text-slate-500 hover:text-slate-300"}`}
          >
            {t.label}
            {t.count != null && <span className={`rounded-full px-1.5 py-0.5 text-[9px] ${tab === t.key ? "bg-red-500/20 text-red-300" : "bg-white/[.06] text-slate-600"}`}>{t.count}</span>}
          </button>
        ))}
      </div>
              ...
              <div className="space-y-4 px-4 py-4">
                    ...
                    {DAYS.map(d => {
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-md px-2 py-1 text-[9px] font-semibold transition-colors ${active ? "bg-red-500/20 text-red-300 border border-red-500/20" : "bg-white/[.03] text-slate-600 border border-white/[.06] hover:text-slate-400"}`}
                        >
                          {d}
                        </button>
                      );
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="rounded-md border border-white/[.07] bg-white/[.03] px-2 py-1 text-xs text-white outline-none focus:border-red-500/30"
                    />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    className="w-20 rounded-md border border-white/[.07] bg-white/[.03] px-2 py-1 text-xs text-white outline-none focus:border-red-500/30 text-right"
                  />
                </div>
              </div>
            </div>
