...
function JsonBlock({ data, title }: { data: unknown; title: string }) {
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-[var(--border-soft)] bg-[var(--surface-card)]">
      <div className="border-b border-[var(--border-soft)] px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-zinc-500">{title}</div>
...
export function AgentActivityPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      <div className="overflow-hidden rounded-sm border border-[var(--border-soft)] bg-[var(--surface-page)] font-mono text-zinc-300">
        {/* Title bar */}
        <div className="flex items-center justify-between gap-3 border-b border-[var(--border-soft)] px-5 py-3.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => refetch()} className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--border-soft)] bg-[var(--surface-card)] px-2.5 py-1 text-[11px] text-zinc-400 transition-colors hover:text-zinc-200">
        ...
        <div className="p-5">
                    ...
                    <div key={r.label}
                      ...
                      {runnable && (
                        <button onClick={() => runAgent.mutate(id)} disabled={busy === id} title="Run this agent now"
                          className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border border-[var(--border-strong)] text-zinc-400 transition-colors hover:border-zinc-500 hover:text-zinc-200 disabled:opacity-50">
          ...
          <div className="mb-3 flex flex-wrap items-center gap-2">
            ...
            {agentFilter && (
              <button onClick={() => setAgentFilter(null)} className="rounded-md border border-[var(--border-soft)] px-2 py-1 text-[11px] text-zinc-400 hover:text-zinc-200">
                              ...
                              <div className="ml-[34px] space-y-3 border-l border-[var(--border-soft)] py-3 pl-5 pr-4">
                                ...
                                <div className="flex items-center gap-2 pt-0.5">
                                  <button onClick={() => replayRun.mutate(a.id)} disabled={busy === a.id}
                                    className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--border-strong)] px-2.5 py-1 text-[11px] text-zinc-300 transition-colors hover:border-zinc-500 hover:text-zinc-100 disabled:opacity-50">
