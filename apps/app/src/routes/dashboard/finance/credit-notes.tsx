...
const STATUS_CONFIG: Record<CreditStatus, { label: string; color: string; icon: React.ElementType }> = {
  ...
  void:             { label: "Void",             color: "text-zinc-600 bg-zinc-600/10",     icon: XCircle       },
};
      ...
      <div className="w-full max-w-md rounded-2xl border border-white/[.08] bg-[#0f1117] shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-[10px] font-semibold uppercase tracking-wider text-zinc-600 mb-1">Reason</label>
            ...
            <div>
              <label className="block text-[10px] font-semibold uppercase tracking-wider text-zinc-600 mb-1">Initial status</label>
              ...
              {creditNotes.map(cn => {
                ...
                return (
                  <tr key={cn.id}
                    ...
                    <td className="px-4 py-3">
                      <span className="text-[11px] text-zinc-400 rounded-full bg-white/[.04] px-2 py-0.5">{REASON_LABELS[cn.credit_reason]}</span>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 max-w-[220px]">
                      {cn.ai_summary ? (
                        <div className="flex items-start gap-1.5">
                          ...
                          <span className="text-[11px] text-zinc-500 truncate">{cn.ai_summary}</span>
                        </div>
