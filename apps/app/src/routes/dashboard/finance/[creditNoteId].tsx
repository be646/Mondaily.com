...
export function CreditNoteDetailPage() {
  ...
  if (isError || !cn) return <div className="flex h-full items-center justify-center text-[12px] text-red-400">Credit note not found.</div>;
        ...
        <aside className="w-[260px] shrink-0 border-r border-white/[.06] flex flex-col overflow-y-auto">
          ...
          {transitions.length > 0 && (
            <div className="p-4 space-y-2">
              ...
              {transitionError && (
                <div className="flex items-start gap-1.5 rounded-lg border border-red-500/20 bg-red-500/[.06] px-3 py-2 text-[11px] text-red-400">
