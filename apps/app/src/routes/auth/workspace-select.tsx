      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-2">
          {memberships.map(({ organization, role }) => (
            <button key={organization.id} onClick={() => selectWorkspace(organization.id)} className="flex w-full items-center gap-3 rounded-lg border border-white/10 p-3 text-left hover:bg-white/[.04]">
